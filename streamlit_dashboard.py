...
from diagram_renderer import ArchitectureDiagramRenderer

# Import the enhanced diagram renderer
try:
    from diagram_renderer import ArchitectureDiagramRenderer
    DIAGRAM_RENDERER_AVAILABLE = True
except ImportError:
    DIAGRAM_RENDERER_AVAILABLE = False
    st.warning("⚠️ Enhanced diagram renderer not available. Using basic fallback.")
...
def display_architecture_diagrams():
    """Display the three architecture diagrams using the robust renderer"""
    st.markdown("## 🏗️ Solution Architecture Diagrams")
    st.markdown("Comprehensive visual overview of the Coca-Cola Sales Intelligence Platform architecture.")
    
    # Create sub-tabs for the three architecture diagrams
    ...
    with arch_tab1:
        st.markdown("### High-Level Platform Architecture")
        st.markdown("Complete system overview showing frontend, backend, AI intelligence, and data layers.")
        
        # Use the robust diagram renderer
        ArchitectureDiagramRenderer.render_architecture_diagram("high_level")
        
        # Additional context
        with st.expander("📋 Architecture Details"):
            st.markdown("""
            **Frontend Layer**: Streamlit-based executive dashboard with interactive analytics
            - KPI monitoring and visualization
            - Real-time data updates
            - Executive-level insights
            
            **Backend Layer**: FastAPI REST API with agent orchestration
            - Scalable microservices architecture
            - Agent coordination and management
            - Business logic processing
            
            **AI Intelligence Layer**: Azure OpenAI GPT-4o with Semantic Kernel
            - 6 specialized AI agents
            - Advanced prompt engineering
            - Function calling capabilities
            
            **Data Layer**: Multi-source enterprise data integration
            - 523 accounts, 247 opportunities
            - CRM, IoT, and communication data
            - Real-time analytics processing
            """)
        
    with arch_tab2:
        st.markdown("### AI Agent Ecosystem Architecture")
        st.markdown("Detailed view of the six specialized AI agents and their orchestration through Semantic Kernel.")
        
        # Use the robust diagram renderer
        ArchitectureDiagramRenderer.render_architecture_diagram("ai_agents")
        
        # Additional context
        with st.expander("🤖 AI Agent Details"):
            col1, col2 = st.columns(2)
            
            with col1:
                st.markdown("""
                **Core Sales Agents**:
                - **Sales Performance Agent**: Revenue optimization and territory analysis
                - **Customer Relationship Agent**: Account health and engagement scoring
                
                **Analytics Agents**:
                - **Forecasting Agent**: Predictive sales modeling
                - **Risk Assessment Agent**: Churn prediction and risk scoring
                """)
            
            with col2:
                st.markdown("""
                **Intelligence Agents**:
                - **Market Intelligence Agent**: Competitive analysis and trends
                - **Competitive Analysis Agent**: Market positioning insights
                
                **Orchestration**:
                - **Semantic Kernel**: Centralized agent coordination
                - **Azure OpenAI GPT-4o**: Unified reasoning engine
                """)
    
    with arch_tab3:
        st.markdown("### Data Integration Architecture")
        st.markdown("Comprehensive data flow from multiple enterprise sources through processing layers to intelligence outputs.")
        ...
        with st.expander("📊 Data Flow Details"):
            st.markdown("""
            **Data Sources**:
            - **CRM System**: Account and contact management data
            - **Freestyle Machines**: IoT telemetry and usage analytics
            - **Communication Logs**: Email and call interaction data
            - **Market Data**: Competitive intelligence and trends
            
            **Processing Pipeline**:
            - **Data Ingestion**: Real-time data collection and validation
            - **ETL Processing**: Extract, transform, load operations
            - **AI Processing**: Semantic analysis and insight generation
        ...
        col1, col2, col3, col4 = st.columns(4)
        with col1:
            st.metric("Total Accounts", "523", "+12%")
        with col2:
            st.metric("Active Opportunities", "247", "+8%")
        with col3:
            st.metric("Data Sources", "8", "100%")
        with col4:
            st.metric("AI Processing Layers", "3", "Active")
    ...
    with col1:
        ...
        **🏢 High-Level Architecture**
        ...
        - AI Layer: Azure OpenAI GPT-4o + Semantic Kernel
        - Data Layer: Enterprise-scale data integration
        """)
    
    with col2:
        st.markdown("""
        **🤖 AI Agent Ecosystem** 
        - 6 specialized AI agents for different business functions
        - Semantic Kernel orchestration and coordination
    ...
    with col3:
        st.markdown("""
        **📊 Data Integration**
        - Multiple enterprise data sources (CRM, IoT, ERP)
        - Real-time and batch processing pipelines
        - Data quality validation and normalization
        - Executive-ready business intelligence views
        """)
...
def main():
    ...
    <div style="text-align: center; padding: 2rem; color: #6B7280;">
        <p>🥤 Coca-Cola Sales Executive Intelligence Platform</p>
